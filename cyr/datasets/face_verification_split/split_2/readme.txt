# train_exp_*.txt ? samples, id: 30% of [1-63], band: [550,570,...,990], multispectral, non-obtructive.
- train_exp_{i}.txt denotes i-th random experiment.

# pairs_exp_*.txt 8280 samples, id: 70% of [1-63] and [train_id,pairs_id]=[1-63], band: [550,570,...,990], multispectral, non-obtructive.
