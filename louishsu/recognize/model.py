...
class VGG(nn.Module):
    ...
    def __init__(self, in_channels, n_classes, netname, batch_norm=False, init_weights=True, finetune=True, pretrain_path=None):
    ...
    def _make_layer(self, netname, in_channels, batch_norm=False):
        ...
        for v in cfg:
            if v == 'M':
                ...
                in_channels = v
        layers += [nn.AvgPool2d(kernel_size=(2, 2))]
...
models = {
    'recognize_vgg11': VGG(configer.n_usedChannels, configer.n_classes, 'VGG11', batch_norm=True, finetune=True, pretrain_path=None),
}